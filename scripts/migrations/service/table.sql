...
create table if not exists expenses (
    `expenseCode` int not null, `expenseName` VARCHAR(100) not null, `type` VARCHAR(100) not null, `price` int not null, `inUsed` BOOLEAN not null, `createdAt` datetime DEFAULT NOW(), `updatedAt` datetime DEFAULT NULL, `createdBy` varchar(50) DEFAULT NULL, `updatedBy` varchar(50) DEFAULT NULL, PRIMARY KEY (`expenseCode`)
);
